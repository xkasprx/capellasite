...
async function loadDashboard(){
	...
	editProfileButton.innerHTML = `<i class="fa-solid fa-user"></i>  Edit Profile`;
	addExpButton.innerHTML = `<i class="fa-solid fa-briefcase"></i>  Add Experience`;
	addEduButton.innerHTML = `<i class="fa-solid fa-briefcase"></i>  Add Education`;
