...
async function loadForgotPass(){
	...
	formEmail.innerHTML = `<label>Email</label><input id="email" type="email" onchange="validateInput(this, this.type);"></input>`;
...
async function loadLogin(){
	...
	formEmail.innerHTML = `<label>Email</label><input id="email" type="email" onchange="validateInput(this, this.type);"></input>`;
	formPassword.innerHTML = `<label>Password</label><input id="pass" type="password" onchange="validateInput(this, this.type);"></input>`;
...
async function loadRegister(){
	...
	formEmail.innerHTML = `<label>Email</label><input id="email" type="email" onchange="validateInput(this, this.type);"></input>`;
	formPassword.innerHTML = `<label>Password</label><input id="pass" type="password" onchange="validateInput(this, this.type);"></input>`;
	formVerify.innerHTML = `<label>Verify</label><input id="passverify" type="password" onchange="validateInput(this, this.type);"></input>`;
