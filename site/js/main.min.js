...
async function loadDashboard(){
	...
	addEduButton.setAttribute(`onclick`, `loadAddEdu();`);
	addExpButton.setAttribute(`onclick`, `loadAddExp();`);
	editProfileButton.setAttribute(`onclick`, `loadEditProfile();`);
...
async function loadEditProfile(){
	...
	professionalStatus.innerHTML = `<label>Professional Status</label>` + await new Promise((resolve) => {
		let s = ``;
		let choices = [
			`Click to Select`,
			`Back-end Developer`,
	...
	firstName.innerHTML = `<label>First Name</label><input id="firstName" placeholder="John" value="${userInfo.firstName || ``}">`;
	lastName.innerHTML = `<label>Last Name</label><input id="lastName" placeholder="Smith" value="${userInfo.lastName || ``}">`;
	email.innerHTML = `<label>Email</label><input id="email" value="${userInfo.email}">`;
	company.innerHTML = `<label>Company</label><input id="company" placeholder="Your own copmany or one you work for" value="${userInfo.company || ``}">`;
	website.innerHTML = `<label>Website</label><input id="website" placeholder="Portfolio site, Company website, etc" value="${userInfo.website || ``}">`;
	location.innerHTML = `<label>City, State</label><input id="location" placeholder="Denver, CO" value="${userInfo.location || ``}">`;
	skills.innerHTML = `<label>Skills</label><input id="skills" placeholder="Comma Seperated" value="${userInfo.skills || ``}">`;
	bio.innerHTML = `<label>Bio</label><textarea id="bio" style="height: 100px; margin-top: 10px;" placeholder="Short description about what you do, what you like, etc">${userInfo.bio || ``}</textarea>`;
	socialLinks.innerHTML = `<h2>Across the Internet</h2>`;
	github.innerHTML = `<label><i class="fa-brands fa-github"></i>  GitHub</label><input id="github" placeholder="myGitName" value="${userInfo.github || ``}">`;
	twitter.innerHTML = `<label><i class="fa-brands fa-x-twitter"></i>  Twitter</label><input id="twitter" placeholder="https://twitter.com/yourusername" value="${userInfo.twitter || ``}">`;
	facebook.innerHTML = `<label><i class="fa-brands fa-facebook"></i>  Facebook</label><input id="facebook" placeholder="https://facebook.com/yourusername" value="${userInfo.facebook || ``}">`;
	youtube.innerHTML = `<label><i class="fa-brands fa-youtube"></i>  YouTube</label><input id="youtube" placeholder="https://youtube.com/@yourusername" value="${userInfo.youtube || ``}">`;
	linkedin.innerHTML = `<label><i class="fa-brands fa-linkedin"></i>  LinkedIn</label><input id="linkedin" placeholder="https://linkedin.com/in/yourusername" value="${userInfo.linkedin || ``}">`;
	instagram.innerHTML = `<label><i class="fa-brands fa-instagram"></i>  Instagram</label><input id="instagram" placeholder="https://instagram.com/yourusername" value="${userInfo.instagram || ``}">`;
...
async function loadForgotPass(){
	...
	formEmail.innerHTML = `<label>Email</label><input id="email" type="email" onchange="validateInput(this, this.type);">`;
...
async function loadLogin(){
	...
	formEmail.innerHTML = `<label>Email</label><input id="email" type="email" onchange="validateInput(this, this.type);">`;
	formPassword.innerHTML = `<label>Password</label><input id="pass" type="password" onchange="validateInput(this, this.type);">`;
...
async function loadRegister(){
	...
	formFirstName.innerHTML = `<label>First Name</label><input id="firstName">`;
	formLastName.innerHTML = `<label>Last Name</label><input id="lastName">`;
	formEmail.innerHTML = `<label>Email</label><input id="email" type="email" onchange="validateInput(this, this.type);">`;
	formPassword.innerHTML = `<label>Password</label><input id="pass" type="password" onchange="validateInput(this, this.type);">`;
	formVerify.innerHTML = `<label>Verify</label><input id="passverify" type="password" onchange="validateInput(this, this.type);">`;
